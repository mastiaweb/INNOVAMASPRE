...
import { Target, Heart, Zap, BookOpen, Library, Presentation, CheckCircle, GraduationCap, Clock, Users, Shield } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in pb-20 bg-slate-50">
       {/* Standard Header */}
       <PageHeader 
         title="Nosotros" 
      ...
      <div className="container mx-auto px-4 py-16 space-y-24">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          {/* Added md:pl-16 for the requested spacing (padding to the right of the container edge/left of text) */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Misión */}
          <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-brand-cyan hover:shadow-xl transition hover:-translate-y-1 duration-300">
          ...
          {/* Visión */}
          <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-brand-magenta hover:shadow-xl transition hover:-translate-y-1 duration-300">
          ...
          {/* Valores */}
          <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-brand-yellow hover:shadow-xl transition hover:-translate-y-1 duration-300">
        ...
        {/* NEW SECTION: Beneficios Académicos */}
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
             {benefits.map((benefit) => (
               <div key={benefit.id} className="group flex flex-col items-center text-center cursor-default">
